...
| **01** | ⛰ Topographie & Microclimat | `p01-topographie` | DEM 3D, profils de pente, ravines, vents, héliodone, bloc bioclim Köppen + précipitations ERA5 |
...
│   ├── auto-plan-strategies.js      ← 4 stratégies (rect/oblique/zone/multi-blocs)
...
│   ├── geo-utils.js                 ← Helpers géodésiques transverses
